<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadNewHomeWorkPage.aspx.cs" Inherits="UploadNewHomeWorkPage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ASSIGNMENT CENTRE - Upload HW</title>
    ...
    <div class="all_site">
        <form id="form1" runat="server" data-ng-app="myApp" data-ng-controller="HWCtrl">
            ...
            <div id="headLine" style="text-align: center">
                ...
                <img src="img/upload_new_hw.png" style="width: 100%" />
                    ...
                    <tr>
                        ...
                        <td class="TextBoxStyle">
                            ...
                            <div class="input-group" style="width: 150px">
                                ...
                                <asp:TextBox ID="TextBox1" PlaceHolder="ddmmyyyy" runat="server" CssClass="form-control" name="date" type="text" Height="30px" Width="10px"></asp:TextBox>
                            </div>
                        </td>
