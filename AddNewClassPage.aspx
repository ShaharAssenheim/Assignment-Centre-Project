<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddNewClassPage.aspx.cs" Inherits="AddNewClassPage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ASSIGNMENT CENTRE - Add Class</title>
...
<body style="background: url(img/2.png) no-repeat center center fixed; background-size: cover;">
    ...
    <form id="form1" runat="server" data-ng-app="myApp" data-ng-controller="HWCtrl">
        ...
        <div id="headline" style="text-align: center">
            <img src="img/add_Class.png" style="width: 100%" />
        </div>
        <div id="wrapper3">
            <br />
            <br />
            <table class="TableStyle">
                <tr>
                    ...
                    <td class="TextBoxStyle">
                        <asp:TextBox ID="TextBoxClass" runat="server" CssClass="form-control" Height="30px" Width="150px"></asp:TextBox>
                    </td>
                    <td class="ErrMsgStyle">&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please enter class name" ControlToValidate="TextBoxClass" ForeColor="Red"></asp:RequiredFieldValidator>
                    </td>
                </tr>
            </table>
            <br />
