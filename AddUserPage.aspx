<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddUserPage.aspx.cs" Inherits="AddUserPage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ASSIGNMENT CENTRE - Add User</title>
...
<body style="background: url(img/2.png) no-repeat center center fixed; background-size: cover;">
    ...
    <form id="form1" runat="server" data-ng-app="myApp" data-ng-controller="HWCtrl">
        ...
        <div id="headline" style="text-align: center">
            <img src="img/add_user.png" style="width: 100%" />
        </div>
        <div id="wrapper3">
            <br />
            <br />
            <table class="TableStyle">
                <tr>
                    ...
                    <td class="TextBoxStyle">
                        <asp:TextBox ID="TextBoxID" runat="server" CssClass="form-control" Height="30px" Width="150px"></asp:TextBox>
                    </td>
                    <td class="ErrMsgStyle">&nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please enter user ID" ControlToValidate="TextBoxID" ForeColor="Red"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="LableStyle">User Name</td>
                    <td class="TextBoxStyle">
                        <asp:TextBox ID="TextBoxUN" runat="server" CssClass="form-control" Height="30px" Width="150px"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td class="TextBoxStyle">
                        <asp:TextBox ID="TextBoxPass" runat="server" CssClass="form-control" Height="30px" Width="150px" TextMode="Password"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td class="TextBoxStyle">
                        <select id="DropDownListRole" name="DropDownListRole" class="form-control">
                            <option data-ng-repeat="t in Role" value="{{t.id}}">{{t.name}}</option>
                        </select>
                    </td>
                    <td style="text-align: left">&nbsp;
                    <asp:Label ID="Label1" runat="server" ForeColor="Red" Text="Please Select Role" Visible="False"></asp:Label>
                    </td>
                </tr>
            </table>
            <br />
