<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HomeWorkPage.aspx.cs" Inherits="HomeWorkPage" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>HWM - HW Page</title>
            ...
            <div id="wrapper3">
                ...
                <table class="TableStyle">
                    ...
                    <tr>
                        ...
                        <td class="TextBoxStyle">
                            <asp:Button ID="Button7" CssClass="btn btn-primary" runat="server" Text="Download" OnClick="DowloadHwBtn" />
                    ...
                    <tr>
                        ...
                        <td class="TextBoxStyle">
                            <asp:Button ID="Button8" CssClass="btn btn-primary" runat="server" Text="Download" Enabled="False" OnClick="DownladSubBtn" />
                    ...
                    <tr>
                        ...
                        <td style="text-align: left">
                            <asp:Button ID="Button9" CssClass="btn btn-primary" runat="server" Text="Save" OnClick="SaveBtn" />
                        </td>
                    </tr>
