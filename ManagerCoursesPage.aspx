<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManagerCoursesPage.aspx.cs" Inherits="ManagerCoursesPage" %>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>ASSIGNMENT CENTRE - Courses</title>
...
<body style="background: url(img/2.png) no-repeat center center fixed; background-size: cover;">
    ...
    <form id="form1" runat="server" data-ng-app="myApp" data-ng-controller="HWCtrl">
        ...
        <div id="headline" style="text-align: center">
            <img src="img/courses.png" style="width: 100%" />
        </div>
        <div id="wrapper3">
            <div style="width: 50%; height: 350px; overflow: scroll">
                <asp:GridView ID="GridView1" BorderColor="Transparent" OnRowCommand="GridView_OnRowCommand" class="table table-striped" HeaderStyle-BackColor="White" HeaderStyle-ForeColor="Black" ForeColor="Black"
                    runat="server" Width="100%" AutoGenerateColumns="False" DataKeyNames="name" AllowSorting="True" DataSourceID="SqlDataSource1">
                    <Columns>
                        <asp:BoundField DataField="name" HeaderText="Course Name" ItemStyle-Width="150" ReadOnly="True" SortExpression="name" />
            ...
            <div style="margin-left: -430px;">
                &nbsp;<asp:Button ID="Button4" runat="server" CssClass="btn btn-primary" Text="Add Course" OnClick="AddCourseBtn" />
